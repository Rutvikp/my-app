        ...
        <Container className="p-0 " fluid={true}>
            ...
            <Content>
                ...
                <h5 className="font-weight-lighter"> At Bendix I had the chance to work on the assembly of an Air-Board that represented Bendix's brake systems, employed by over 70%
                    ...
                    designed for students. I cut an assembled 40 of these pieces improving my circuit design, soldering, coding and planning skills.  </h5>
                <br></br>
                ...
                <h5 className="font-weight-lighter"> At Loopio, I gained a better appreciation for testing in a Software environment as it can help design a very robust and efficent product. 
                    ...
                    customer data. One of the most interesting portions of the term was when I got to work on re-factoring React code. Additionally, I worked on resolving 50+ bugs and necessary design tweaks on the website. </h5>
                <br></br>
